...
const Following = () => {
    ...
    const followers = [
        {id: 1, name: "John Smith", username: "j.smith", img: "https://i.pravatar.cc/200?u=john@geekspark.com", followed: true},
        ...
        {id: 5, name: "John Snow", username: "jsonw", img: "https://i.pravatar.cc/200?u=jsnow@geekspark.com", followed: true},
        {id: 6, name: "James Anderson", username: "james_and", img: "https://i.pravatar.cc/200?u=jamie@geekspark.com", followed: true},
        {id: 7, name: "Jakie", username: "jakie157", img: "https://i.pravatar.cc/200?u=jakie@geekspark.com", followed: true},
        {id: 8, name: "Robin", username: "ro_bin", img: "https://i.pravatar.cc/200?u=robin@geekspark.com", followed: true},
    ...
    return(
        <SafeAreaView style={getStyles(mode).container}>
            ...
            <View style={{paddingHorizontal: 15}}>
                <HeadingSub heading="Following" sub="100 following" />
            </View>
